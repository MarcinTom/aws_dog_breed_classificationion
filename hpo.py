...
def net():
    ...
    model.fc = nn.Linear(num_features, 133) # 133 is the number of dog classes
...
def main(args):
    ...
    # model = train(model, train_loader, val_loader, loss_criterion, optimizer, args.epochs, device, logger)
